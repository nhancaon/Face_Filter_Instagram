...
class ImageDisplayApp:
    def __init__(self, master):
        ...
        self.close_button = CTkButton(button_frame, text="Exit", corner_radius=32, fg_color="transparent", hover_color="#76520e", border_color="#FFCC70", border_width=2, command=self.close_app)
        self.close_button.grid(row=0, column=0, padx=4, pady=10)

        # Create a button to open camera
        self.open_cam_button = CTkButton(button_frame, text="Open Cam", corner_radius=32, fg_color="transparent", hover_color="#76520e", border_color="#FFCC70", border_width=2, command=self.open_camera)
        self.open_cam_button.grid(row=0, column=1, padx=4, pady=10)

        # Create a button to filter
        self.sun_glass_button = CTkButton(button_frame, text="SunGlass", corner_radius=32, fg_color="transparent", hover_color="#76520e", border_color="#FFCC70", border_width=2, command=lambda: self.turn_flag(1, "SunGlass_filter"))
        self.sun_glass_button.grid(row=0, column=2, padx=4, pady=10)

        self.clown_button = CTkButton(button_frame, text="Clown", corner_radius=32, fg_color="transparent", hover_color="#76520e", border_color="#FFCC70", border_width=2, command=lambda: self.turn_flag(2, "Clown"))
        self.clown_button.grid(row=0, column=3, padx=4, pady=10)

        self.cry_button = CTkButton(button_frame, text="Cry", corner_radius=32, fg_color="transparent", hover_color="#76520e", border_color="#FFCC70", border_width=2, command=lambda: self.turn_flag(3, "Cry_filter"))
        self.cry_button.grid(row=0, column=4, padx=4, pady=10)

        self.bat_button = CTkButton(button_frame, text="Batman", corner_radius=32, fg_color="transparent", hover_color="#76520e", border_color="#FFCC70", border_width=2, command=lambda: self.turn_flag(4, "Bat_Filter"))
        self.bat_button.grid(row=0, column=5, padx=4, pady=10)

        self.tear_button = CTkButton(button_frame, text="Tear", corner_radius=32, fg_color="transparent", hover_color="#76520e", border_color="#FFCC70", border_width=2, command=lambda: self.turn_flag(5, "Tear_filter"))
        self.tear_button.grid(row=1, column=0, padx=4, pady=10)

        self.sharingan_button = CTkButton(button_frame, text="Sharingan", corner_radius=32, fg_color="transparent", hover_color="#76520e", border_color="#FFCC70", border_width=2, command=lambda: self.turn_flag(6, "Sharingan_filter"))
        self.sharingan_button.grid(row=1, column=1, padx=4, pady=10)

        self.venom_button = CTkButton(button_frame, text="Venom", corner_radius=32, fg_color="transparent", hover_color="#76520e", border_color="#FFCC70", border_width=2, command=lambda: self.turn_flag(7, "SkiMask_filter"))
        self.venom_button.grid(row=1, column=2, padx=4, pady=10)

        self.thief_button = CTkButton(button_frame, text="Thief", corner_radius=32, fg_color="transparent", hover_color="#76520e", border_color="#FFCC70", border_width=2, command=lambda: self.turn_flag(9, "SkiMask_filter"))
        self.thief_button.grid(row=1, column=3, padx=4, pady=10)

        self.regco_button = CTkButton(button_frame, text="Recognition", corner_radius=32, fg_color="transparent", hover_color="#76520e", border_color="#FFCC70", border_width=2, command=lambda: self.turn_flag(10, ""))
        ...
        if self.cap is not None:
            ...
            if success:
                if self.flag == 10:
                    ...
                    self.canvas_2.create_image(0, 0, anchor="nw", image=self.photo2)
                    self.flag = 0
